...
const { nme, place, categories } = restaurant;
console.log(nme, place, categories);
...
restaurantCopy.nme = 'Ristorante Roma';
console.log(restaurantCopy.nme);
console.log(restaurant.nme);
...
const [ax, by, ...otherss] = [1, 2, 3, 4, 5];
console.log(ax, by, otherss);
...
const menuunw = [...restaurant.starterMenu, ...restaurant.mainMenu];
for (const item of menuunw) console.log(item);

for (const [i, el] of menuunw.entries()) {
  console.log(`${i + 1}: ${el}`);
}
...
// rest.clear();
const arrrra = [1, 2];
rest.set(arrrra, 'Test');
rest.set(document.querySelector('h1'), 'Heading');

console.log(rest);
console.log(rest.size);
console.log(rest.get(arrrra));
